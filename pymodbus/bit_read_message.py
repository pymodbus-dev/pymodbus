...
An example flow of data:
  ...
  #. Modbus client builds a request message
  #. Modbus client sends request to Modbus server
  #. <work with data>
  #. Modbus server receives request and decodes
  #. Modbus server passes its context the request execute method
  #. Modbus server Sends the response message generated by execute to client
  #. <work with data>
  #. Modbus client receives response and decodes
