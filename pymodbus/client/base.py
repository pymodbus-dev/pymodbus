...
class ModbusBaseClient(ModbusClientMixin):
    ...
    **Parameters common to all clients**:
    ...
    :param reconnect_delay_min: (optional) Minimum delay in milliseconds before reconnecting.
    ...
    .. tip::
        ...
        **reconnect_delay_min** to **reconnect_delay_max**.
        Set `reconnect_delay_min=0` to avoid automatic reconnection.
    ...
    **Application methods, common to all clients**:
    ...
    def __init__(
        ...
        reconnect_delay_min: int = Defaults.ReconnectDelayMin,
        ...
        **kwargs: any,
        ...
        self.params.reconnect_delay_min = int(reconnect_delay_min)
