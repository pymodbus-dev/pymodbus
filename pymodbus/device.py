...
class DeviceInformationFactory(Singleton):
    ...
    __lookup = {
        ...
        DeviceInformation.Regular: lambda c, r, i: c.__gets(
            r, list(range(i, 0x07)) if c.__get(r, i)[i] else list(range(0, 0x07))
        ),
        DeviceInformation.Extended: lambda c, r, i: c.__gets(
            r,
