...
class TestPdu:
    ...
    @pytest.mark.parametrize(("pdutype", "args", "kwargs", "framer"), requests)
    @pytest.mark.usefixtures("kwargs", "args", "framer")
    ...
    @pytest.mark.parametrize(("pdutype", "args", "kwargs", "framer"), requests + responses)
    @pytest.mark.usefixtures("framer", "args")
