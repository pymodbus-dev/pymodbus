...
class SimpleFactoryTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.request = (
            ...
            (
                0x14,
                b"\x14\x0e\x06\x00\x04\x00\x01\x00\x02" b"\x06\x00\x03\x00\x09\x00\x02",
            ),  # read file record
            (
                0x15,
                b"\x15\x0d\x06\x00\x04\x00\x07\x00\x03" b"\x06\xaf\x04\xbe\x10\x0d",
            ),  # write file record
        ...
        self.response = (
            ...
            (
                0x14,
                b"\x14\x0c\x05\x06\x0d\xfe\x00\x20\x05" b"\x06\x33\xcd\x00\x40",
            ),  # read file record
            (
                0x15,
                b"\x15\x0d\x06\x00\x04\x00\x07\x00\x03" b"\x06\xaf\x04\xbe\x10\x0d",
